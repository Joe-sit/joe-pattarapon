...
export const INTRO_BEATS = [
  ['face', 0.0, 3.2],
  // เริ่มก่อนบีต face จบ — ของเดิม 2.9 มีช่วงตาย ~0.8s (หัวหันเสร็จ ~2.1 กล้องยังนิ่ง)
  // ease-in ของกล้องช้ามาก ครึ่งวินาทีแรกแทบไม่ขยับ จึงทับกับหัวที่กำลังหันกลับได้เนียน ๆ
  ['pull', 2.45, 7.0],
  ['crop', 4.4, 7.6],
  ['title', 6.9, 10.2],
]
