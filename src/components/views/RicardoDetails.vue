...
<template>
    <div>
        ...
        <!--Title-->
        <h1 class="flex mx-auto font-bold text-2xl sm:text-3xl text-[#EB5757]">
            {{ portName }}
        </h1>
        <!--Sub Title-->
...
border border-[#B5B5B5] rounded-3xl flex flex-col justify-between">
                    ...
                    <div>
                        <h1 class="text-[#EB5757] text-base font-bold mt-6 mx-6">Overview</h1>
                    ...
                    <div class="flex justify-end mx-6 mb-6 mt-4 ">
                        <a href="https://scratch.mit.edu/projects/315471743" target="_blank" class="flex items-center text-[#fff] bg-[#EB5757] my-2 rounded-3xl 
px-4 py-2 transition-colors duration-300 ease-in-out hover:bg-[#b92b2b] ">
                            Try playing
...
px-2 py-2">
                    ...
                    <!-- Tools -->
                    <h1 class="text-[#EB5757] text-base font-bold mt-4 mx-4">Tools</h1>
                    <div class="w-full mt-4 mx-4">
                        <div class="">
                            <div class="flex items-center my-2 py-2 ">
                                <span class="inline-block align-middle mr-2">
                                    <scratchIcon class="h-6 w-6 fill-[#EB5757]" />
                                </span>
                    ...
                    <div class="mt-6">
                        <!-- More/Method -->
                        <h1 class="text-[#EB5757] text-base font-bold mx-5">Learn more</h1>
                        <div @click="goToYouTube()"
                            ...
                            <div class="">
                                <div class="flex items-center px-3 py-2  ">
                                    ...
                                    <span class="text-sm sm:text-base text-[#1c1c1c] space-nowrap ">Fuelvin
                                    </span>
...
class="text-sm sm:text-base text-[#1c1c1c] [#F04E23] space-nowrap font-bold">e-Book
            ...
            <div>
                ...
                <!--Product Overview-->
                <div class="mt-10">
                    <h1 class="text-[#EB5757] text-xl sm:text-2xl font-bold mb-6">Instructions</h1>
                    <p class="text-[#1c1c1c] text-lg sm:text-xl font-light">1. How to Play Ricardo Your Hero
